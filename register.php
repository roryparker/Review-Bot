        ...
        <div class="login_box">
            ...
            <div id="first">
                ...
                <form action="register.php" method="POST">
                    ...
                    <br>
                    <a href="#" id="signin" class="signin">Already have an account, then sign in!</a>
                </form>
            ...
            <div id="second">
                ...
                <form action="register.php" method="POST">
                    ...
                    <input type="email" name="register_email" placeholder="Email Address"
                        ...
                        required>
                    <br>
                    <input type="email" name="register_email_confirmation" placeholder="Confirm Email Address"
                    ...
                    <input type="password" name="register_password" autocomplete="on" placeholder="Password"
                        value="<?php if (isset($_SESSION['register_password'])) { echo $_SESSION['register_password']; } ?>"
                        required>
                    <br>
                    <input type="password" name="register_password_confirmation" autocomplete="on"
